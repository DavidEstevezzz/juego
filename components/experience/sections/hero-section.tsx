...
/**
 * Capítulo 01. CTA y elementos direccionales en `scarlet`, etiquetas y
 * numeración en latón. Conserva el contenido y la composición actuales;
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 items-center py-16">
        <div className="grid w-full items-end gap-12 lg:grid-cols-[minmax(0,1.35fr)_minmax(280px,0.65fr)]">
          <div>
            {/* Línea roja estructural: la firma negro-rojo está presente desde
                el primer viewport sin llevar el rojo a texto pequeño. */}
            <div data-intro className="signal-rule mb-6" aria-hidden="true" />
            <p
              data-intro
          ...
          <div
            data-intro
            className="border-l border-[color:var(--border-subtle)] pl-5 sm:pl-8"
          >
            ...
            <a
              href="#world"
              className="font-system mt-8 inline-flex items-center gap-3 border-b border-[color:var(--border-scarlet)] pb-2 text-xs uppercase tracking-[0.18em] text-foreground transition-colors hover:border-scarlet hover:text-scarlet"
            >
              Ver capítulos
              <MoveUpRight
                aria-hidden="true"
                className="h-4 w-4 text-scarlet"
              />
            </a>
          </div>
        </div>
      ...
      <div
        data-intro
        className="font-system relative z-10 mx-auto flex w-full max-w-7xl items-end justify-between border-t border-[color:var(--border-subtle)] pt-5 text-[0.65rem] uppercase tracking-[0.2em] text-steel"
      >
